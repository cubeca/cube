 ...
 */
 ...
 const Video = () => {
   ...
   // After editing subtitles, refetch content and update subtitleUrl.
   // This effect runs when location changes or refetch is called.
   // We intentionally don't include subtitleUrl in dependencies to prevent infinite loops,
   // as the URL update itself shouldn't trigger another refetch.
   useEffect(() => {
