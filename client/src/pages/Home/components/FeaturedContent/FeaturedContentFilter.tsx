  ...
  return (
    <s.Filters direction="row" spacing={2} alignItems="center">
      ...
      >
        ...
        <MenuItem value={ContentCategories.DigitalPublications}>{t('Digital Publications')}</MenuItem>
        <MenuItem value={ContentCategories.Talks}>{t('Talks')}</MenuItem>
        <MenuItem value={ContentCategories.Performances}>{t('Performances')}</MenuItem>
        <MenuItem value={ContentCategories.CulturalTeachings}>{t('Cultural Teachings')}</MenuItem>
        <MenuItem value={ContentQueryKeys.SignLanguage}>{t('Has Sign Language')}</MenuItem>
