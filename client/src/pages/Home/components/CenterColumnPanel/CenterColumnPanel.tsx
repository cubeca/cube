      ...
      <Grid container>
        ...
        <Grid xs={10} xsOffset={1} md={4}>
          <s.CenterColumnTextSection>
            ...
            <Typography component="p">
              {t(
                'We are just getting started, so our early adopters get to load as much content as they like and a say in the development of our governance system. Our governance tokens are not a form of currency and cannot be bought or sold. Only earned through acts of knowledge sharing.'
              )}
            </Typography>
