...
const ViewSection: FC<ViewSectionProps> = ({ isLoggedIn, profile, onEdit }) => {
  ...
  <Stack sx={{pt: '0', position: 'fixed', top: '0', right: '-1vw', height: '100%', direction: 'column', backgroundImage: 'linear-gradient(90deg, rgba(40,52,60,0) 3%, rgba(40,52,60,0.3505996148459384) 10%, rgba(40,52,60,0.6979385504201681) 22%, rgba(40,52,60,0.809983368347339) 27%, rgba(40,52,60,0.9304315476190477) 33%, rgba(40,52,60,0.9640449929971989) 43%, rgba(40,52,60,1) 56%)'}}> 
