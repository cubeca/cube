...
// @ts-ignore
import { ListOfCollaboratorsData } from './list-of-collaborators-data';

/**
 * List of collaborators
 * @export
 * @interface ListOfCollaborators
 */
export interface ListOfCollaborators {
    /**
     * 
     * @type {ListOfCollaboratorsData}
     * @memberof ListOfCollaborators
     */
    'data': ListOfCollaboratorsData;
}
