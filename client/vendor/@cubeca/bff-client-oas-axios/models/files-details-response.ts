...
// @ts-ignore
import { FilesDetailsResponsePlayerInfo } from './files-details-response-player-info';

/**
 * FilesDetailsResponse
 * @export
 * @interface FilesDetailsResponse
 */
export interface FilesDetailsResponse {
    /**
     * 
     * @type {string}
     * @memberof FilesDetailsResponse
     */
    'id': string;
    /**
     * 
     ...
     * @memberof FilesDetailsResponse
     */
    'playerInfo': FilesDetailsResponsePlayerInfo;
}
