...
/**
 * Updated Profile audio description Response
 * @export
 * @interface UpdatedProfileAudioDescriptionResponse
 */
export interface UpdatedProfileAudioDescriptionResponse {
    /**
     * 
     * @type {ProfileMainSchema}
     * @memberof UpdatedProfileAudioDescriptionResponse
     */
