...
// @ts-ignore
import { GetFileUploadUrlResponseData } from './get-file-upload-url-response-data';
...
export interface GetFileUploadUrlResponse {
    /**
     * 
     * @type {GetFileUploadUrlResponseData}
     * @memberof GetFileUploadUrlResponse
     */
    'data': GetFileUploadUrlResponseData;
}
